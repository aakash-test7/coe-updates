...
def primer_info_page():
    ...
    header_styled("PRIMER Design and Information", "Enter the Gene ID or NCBI ID to fetch the target sequence and then paste the nucleotide sequence in the Primer design Template section and get the set of primers just clicking Pick primers.")
